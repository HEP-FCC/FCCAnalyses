...
struct getAxisEnergy {
  ...
  bool m_pos = 0; //> Which hemisphere to select, false/0=cosTheta<0 true/1=cosTheta>0
  ROOT::VecOps::RVec<float> operator() (ROOT::VecOps::RVec<float> angle, ROOT::VecOps::RVec<float> charge, ROOT::VecOps::RVec<float> energy);
};
...
struct getAxisN {
  ...
  bool m_pos = 0; //> Which hemisphere to select, false/0=cosTheta<0 true/1=cosTheta>0
  ROOT::VecOps::RVec<int> operator() (ROOT::VecOps::RVec<float> angle,  ROOT::VecOps::RVec<float> charge);
};
