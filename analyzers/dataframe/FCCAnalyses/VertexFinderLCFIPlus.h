...
namespace VertexFinderLCFIPlus{
  ...
  ROOT::VecOps::RVec<ROOT::VecOps::RVec<VertexingUtils::FCCAnalysesVertex>> get_SV_jets( ROOT::VecOps::RVec<edm4hep::ReconstructedParticleData> recoparticles,
											 ...
											 double solenoidBz=2.0, double dR_prefilter_cut=-1., bool require_opp_charge=false, bool tight_v0_seed=false ) ;
  ...
  ROOT::VecOps::RVec<int> VertexSeed_best( ROOT::VecOps::RVec<edm4hep::TrackState> tracks,
					   VertexingUtils::FCCAnalysesVertex PV,
					   double chi2_cut=9., double invM_cut=10., double solenoidBz=2.0, double dR_prefilter_cut=-1., bool require_opp_charge=false, bool tight_v0_seed=false) ;
  ...
  ROOT::VecOps::RVec<VertexingUtils::FCCAnalysesVertex> findSVfromTracks( ROOT::VecOps::RVec<edm4hep::TrackState> tracks_fin,
									  ...
									  VertexingUtils::FCCAnalysesVertex PV,
									  double chi2_cut=9., double invM_cut=10., double chi2Tr_cut=5., double solenoidBz=2.0, double dR_prefilter_cut=-1., bool require_opp_charge=false, bool tight_v0_seed=false) ;
