...
source setup.sh
OUTPUT_DIR=${FCCANA_LOCAL_DIR}/dummy_analysis
LD_LIBRARY_PATH=${FCCANA_LOCAL_DIR}/install:${LD_LIBRARY_PATH}
PYTHONPATH=${FCCANA_LOCAL_DIR}:${PYTHONPATH}
PATH=${FCCANA_LOCAL_DIR}/bin:${FCCANA_LOCAL_DIR}:${PATH}
ROOT_INCLUDE_PATH=${FCCANA_LOCAL_DIR}/install:${ROOT_INCLUDE_PATH}
