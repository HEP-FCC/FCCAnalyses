...
def setup_run_parser_plots(parser):
    ...
    parser.add_argument('--legend-text-size', type=float, default=0.035,
                        help='text size for the legend elements')
    parser.add_argument('--legend-x-min', type=float, default=-1.,
                        help='minimal x position of the legend')
    parser.add_argument('--legend-x-max', type=float, default=-1.,
                        help='maximal x position of the legend')
    parser.add_argument('--legend-y-min', type=float, default=-1.,
                        help='minimal y position of the legend')
    parser.add_argument('--legend-y-max', type=float, default=-1.,
