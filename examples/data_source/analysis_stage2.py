...
processList = {
    # Run over the full statistics from stage1 input files
    # <inputDir>/p8_ee_ZZ_ecm240.root.
    # Keep the same output name as input
    'p8_ee_ZZ_ecm240': {},
    # Run over the statistics from stage1 input files
    # <inputDir>/p8_ee_WW_ecm240_out/*.root.
    # Keep the same output name as input
    'p8_ee_WW_ecm240': {},
    # Run over the full statistics from stage1 input file
    # <inputDir>/p8_ee_ZH_ecm240_out.root.
    # Change the output name to MySample_p8_ee_ZH_ecm240
...
# It can still be EDM4hep files produced standalone or files from a first
# analysis step (this is the case in this example it runs over the files
# produced from analysis.py)
inputDir = "outputs/data_source/stage1"

# Optional:
# Output directory, default is local dir
outputDir = "outputs/data_source/stage2"
...
# Optional:
# Running on HTCondor, default is False
runBatch = False
...
class RDFanalysis():
    ...
    def analysers(dframe):
        ...
        dframe2 = (
            ...
            # Define a weight based on entry
            # (inline example of possible operations)
    ...
    # Mandatory:
    # Output function, please make sure you return the branchlist as a python
    # list.
    def output():
        '''
