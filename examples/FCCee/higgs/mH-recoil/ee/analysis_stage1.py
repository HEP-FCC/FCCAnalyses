'''
Example Higgs recoil mass analysis with electrons.
'''
...
processList = {
    ...
    "p8_ee_ZZ_ecm240": {},
    # Run 50% of the statistics in two files named
    ...
    # <outputDir>/p8_ee_ZH_ecm240_out.root (example on how to change the output
    # name)
    "p8_ee_ZH_ecm240": {
        "fraction": 0.2,
