'''
Example Higgs recoil mass analysis with electrons. Final stage (histogram
preparation).
'''
...
# Dictionary of the list of cuts. The key is the name of the selection that will
...
# Dictionary for the output variable/histograms. The key is the name of the
