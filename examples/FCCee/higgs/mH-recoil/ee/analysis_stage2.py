'''
Example Higgs recoil mass analysis with electrons. Second stage.
'''
...
processList = {
    ...
    "p8_ee_ZH_ecm240_out": {
        "output": "MySample_p8_ee_ZH_ecm240"
    },
}

# Mandatory: input directory when not running over centrally produced edm4hep
# events.
