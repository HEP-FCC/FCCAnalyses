...
class analysis():
    ...
    def run(self):
        ...
        df2 = (self.df
               ...
               .Define("hasPV", "myUtils::hasPV(VertexObject)")
               .Filter("hasPV==1")
...
#smallest and furthest distance of a DV to the PV?
#average DV separation from the PV
#could we have the number of DV's in each hemisphere?
