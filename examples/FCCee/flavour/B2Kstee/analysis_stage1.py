...
class analysis():
    ...
    def run(self):
        ...
        df2 = (self.df
               ...
               #.Define("TrueRho", "myUtils::build_truerho(TrueKPiEE_vertex,MCVertexObject,Particle)")
...
# python examples/FCCee/flavour/B2Kstee/analysis_stage1.py p8_ee_Zbb_Bd2Kstee_stage1.root /eos/experiment/fcc/ee/generation/DelphesEvents/spring2021/IDEA/p8_ee_Zbb_ecm91_EvtGen_Bd2Kstee/events_003598097.root

# python examples/FCCee/flavour/B2Kstee/analysis_stage1.py p8_ee_Zbb_Bs2Kstee_stage1.root /eos/experiment/fcc/ee/generation/DelphesEvents/spring2021/IDEA/p8_ee_Zbb_ecm91_EvtGen_Bs2Kstee/events_003959646.root
