...
class analysis():
    ...
    def run(self):
        ...
        df2 = (self.df
               ...
               ############################################# 
               .Define("EVT_NKiPi",              "float(myUtils::getFCCAnalysesComposite_N(KiPiCandidates))")
               .Filter("EVT_NKiPi>0")
               ...
               .Define("KiPiCandidates_mass",    "myUtils::getFCCAnalysesComposite_mass(KiPiCandidates)")
               .Define("KiPiCandidates_q",       "myUtils::getFCCAnalysesComposite_charge(KiPiCandidates)")
               .Define("KiPiCandidates_vertex",  "myUtils::getFCCAnalysesComposite_vertex(KiPiCandidates)")
               .Define("KiPiCandidates_mcvertex","myUtils::getFCCAnalysesComposite_mcvertex(KiPiCandidates,VertexObject)")
               .Define("KiPiCandidates_px",      "myUtils::getFCCAnalysesComposite_p(KiPiCandidates,0)")
               .Define("KiPiCandidates_py",      "myUtils::getFCCAnalysesComposite_p(KiPiCandidates,1)")
               .Define("KiPiCandidates_pz",      "myUtils::getFCCAnalysesComposite_p(KiPiCandidates,2)")
               .Define("KiPiCandidates_p",       "myUtils::getFCCAnalysesComposite_p(KiPiCandidates,-1)")
               .Define("KiPiCandidates_B",       "myUtils::getFCCAnalysesComposite_B(KiPiCandidates, VertexObject, RecoPartPIDAtVertex)")
               
               .Define("KiPiCandidates_track",   "myUtils::getFCCAnalysesComposite_track(KiPiCandidates, VertexObject)")
               .Define("KiPiCandidates_d0",      "myUtils::get_trackd0(KiPiCandidates_track)")
               .Define("KiPiCandidates_z0",      "myUtils::get_trackz0(KiPiCandidates_track)")

               .Define("KiPiCandidates_anglethrust", "myUtils::getFCCAnalysesComposite_anglethrust(KiPiCandidates, EVT_thrust)")
               .Define("CUT_hasCandEmin",           "myUtils::has_anglethrust_emin(KiPiCandidates_anglethrust)")
               .Filter("CUT_hasCandEmin>0")
               
               .Define("KiPiCandidates_pion1px", "myUtils::getFCCAnalysesComposite_p(KiPiCandidates, VertexObject, RecoPartPIDAtVertex, 0, 0)")
               .Define("KiPiCandidates_pion1py", "myUtils::getFCCAnalysesComposite_p(KiPiCandidates, VertexObject, RecoPartPIDAtVertex, 0, 1)")
               .Define("KiPiCandidates_pion1pz", "myUtils::getFCCAnalysesComposite_p(KiPiCandidates, VertexObject, RecoPartPIDAtVertex, 0, 2)")
               .Define("KiPiCandidates_pion1p",  "myUtils::getFCCAnalysesComposite_p(KiPiCandidates, VertexObject, RecoPartPIDAtVertex, 0, -1)")
               .Define("KiPiCandidates_pion1q",  "myUtils::getFCCAnalysesComposite_q(KiPiCandidates, VertexObject, RecoPartPIDAtVertex, 0)")
               .Define("KiPiCandidates_pion1d0", "myUtils::getFCCAnalysesComposite_d0(KiPiCandidates, VertexObject, 0)")
               .Define("KiPiCandidates_pion1z0", "myUtils::getFCCAnalysesComposite_z0(KiPiCandidates, VertexObject, 0)")
               
               .Define("KiPiCandidates_pion2px", "myUtils::getFCCAnalysesComposite_p(KiPiCandidates, VertexObject, RecoPartPIDAtVertex, 1, 0)")
               .Define("KiPiCandidates_pion2py", "myUtils::getFCCAnalysesComposite_p(KiPiCandidates, VertexObject, RecoPartPIDAtVertex, 1, 1)")
               .Define("KiPiCandidates_pion2pz", "myUtils::getFCCAnalysesComposite_p(KiPiCandidates, VertexObject, RecoPartPIDAtVertex, 1, 2)")
               .Define("KiPiCandidates_pion2p",  "myUtils::getFCCAnalysesComposite_p(KiPiCandidates, VertexObject, RecoPartPIDAtVertex, 1, -1)")
               .Define("KiPiCandidates_pion2q",  "myUtils::getFCCAnalysesComposite_q(KiPiCandidates, VertexObject, RecoPartPIDAtVertex, 1)")
        ...
        for branchName in [
                ...
                "EVT_NtracksPV", "EVT_NVertex", "EVT_NKiPi",
                ...
                "KiPiCandidates_d0",  "KiPiCandidates_z0","KiPiCandidates_anglethrust",
                
                "KiPiCandidates_pion1px", "KiPiCandidates_pion1py", "KiPiCandidates_pion1pz",
                "KiPiCandidates_pion1p", "KiPiCandidates_pion1q", "KiPiCandidates_pion1d0", "KiPiCandidates_pion1z0",
                "KiPiCandidates_pion2px", "KiPiCandidates_pion2py", "KiPiCandidates_pion2pz",
                "KiPiCandidates_pion2p", "KiPiCandidates_pion2q", "KiPiCandidates_pion2d0", "KiPiCandidates_pion2z0",
