...
class RDFanalysis:
    def analysers(df):
        ...
        df2 = (
            ...
            .Define(
                "JetsConstituents_isMu", "JetConstituentsUtils::get_isMu(JetsConstituents_Pids)"
            )
            .Define(
                "JetsConstituents_isEl", "JetConstituentsUtils::get_isEl(JetsConstituents_Pids)"
            )
            .Define(
            ...
            .Define(
                ...
                "JetConstituentsUtils::get_isGamma(JetsConstituents)",
            )
            .Define(
            ...
            .Define(
                ...
                "JetConstituentsUtils::get_dndx(JetsConstituents, EFlowTrack_2, EFlowTrack, JetsConstituents_isChargedHad)",
            )
            .Define(
            ...
            .Define(
                "JetsConstituents_Bz",
                "JetConstituentsUtils::get_Bz(JetsConstituents, EFlowTrack_1)",
            )
            ...
            .Define(
                ...
                "JetConstituentsUtils::get_Sip2dVal_clusterV(jets_ee_genkt, JetsConstituents_dxy, JetsConstituents_phi0, MC_PrimaryVertex, Bz)",
            )
            .Define(
                "JetsConstituents_Sip2dSig",
                "JetConstituentsUtils::get_Sip2dSig(JetsConstituents_Sip2dVal, JetsConstituents_d0_cov)",
            )
            .Define(
                "JetsConstituents_Sip3dVal",
                "JetConstituentsUtils::get_Sip3dVal_clusterV(jets_ee_genkt, JetsConstituents_dxy, JetsConstituents_dz, JetsConstituents_phi0, MC_PrimaryVertex, Bz)",
            )
            .Define(
                "JetsConstituents_Sip3dSig",
                "JetConstituentsUtils::get_Sip3dSig(JetsConstituents_Sip3dVal, JetsConstituents_d0_cov, JetsConstituents_z0_cov)",
            )
            .Define(
                "JetsConstituents_JetDistVal",
                "JetConstituentsUtils::get_JetDistVal_clusterV(jets_ee_genkt, JetsConstituents, JetsConstituents_dxy, JetsConstituents_dz, JetsConstituents_phi0, MC_PrimaryVertex, Bz)",
            )
            .Define(
                "JetsConstituents_JetDistSig",
                "JetConstituentsUtils::get_JetDistSig(JetsConstituents_JetDistVal, JetsConstituents_d0_cov, JetsConstituents_z0_cov)",
            )
            ...
            .Define(
                "nchargedhad", "JetConstituentsUtils::count_type(JetsConstituents_isChargedHad)"
            )
            .Define("nphoton", "JetConstituentsUtils::count_type(JetsConstituents_isGamma)")
            .Define(
                "nneutralhad", "JetConstituentsUtils::count_type(JetsConstituents_isNeutralHad)"
            )
            ...
            .Define(
                "invariant_mass", "JetConstituentsUtils::InvariantMass(tlv_jets[0], tlv_jets[1])"
            )
        )
        return df2
