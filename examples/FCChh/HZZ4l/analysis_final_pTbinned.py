...
inputDir  = "/eos/experiment/fcc/hh/analysis_ntuples/fcc_v07/{}/H4l_analysis/{}".format(detector, energy_point)

#Input directory where the files produced at the pre-selection level are
# outputDir  = "/eos/experiment/fcc/hh/analysis_ntuples/fcc_v06/II/Hmumu_valid/final/"
outputDir  = "/eos/experiment/fcc/hh/analysis_ntuples/fcc_v07/{}/H4l_analysis/{}/final/".format(detector, energy_point)
...
cutList = {
            ...
            "sel3_pTH50_100":"(pT_llll[0] > 50. && pT_llll[0] < 100.) && (ZZ_llll_flavour[0] == 1) && (m_ll_leading[0] > 40. && m_ll_leading[0] < 120. && m_ll_subleading[0] > 12. && m_ll_subleading[0] < 120.)", # increasing pT cuts on the pTmumu 
            "sel3_pTH100_150":"(pT_llll[0] > 100. && pT_llll[0] < 150.) && (ZZ_llll_flavour[0] == 1) && (m_ll_leading[0] > 40. && m_ll_leading[0] < 120. && m_ll_subleading[0] > 12. && m_ll_subleading[0] < 120.)", # increasing pT cuts on the pTmumu 
            "sel3_pTH150_200":"(pT_llll[0] > 150. && pT_llll[0] < 200.) && (ZZ_llll_flavour[0] == 1) && (m_ll_leading[0] > 40. && m_ll_leading[0] < 120. && m_ll_subleading[0] > 12. && m_ll_subleading[0] < 120.)", # increasing pT cuts on the pTmumu 
            "sel3_pTH200_250":"(pT_llll[0] > 200. && pT_llll[0] < 250.) && (ZZ_llll_flavour[0] == 1) && (m_ll_leading[0] > 40. && m_ll_leading[0] < 120. && m_ll_subleading[0] > 12. && m_ll_subleading[0] < 120.)", # increasing pT cuts on the pTmumu 
            "sel3_pTH250_300":"(pT_llll[0] > 250. && pT_llll[0] < 300.) && (ZZ_llll_flavour[0] == 1) && (m_ll_leading[0] > 40. && m_ll_leading[0] < 120. && m_ll_subleading[0] > 12. && m_ll_subleading[0] < 120.)", # increasing pT cuts on the pTmumu 
            "sel3_pTH300_350":"(pT_llll[0] > 300. && pT_llll[0] < 350.) && (ZZ_llll_flavour[0] == 1) && (m_ll_leading[0] > 40. && m_ll_leading[0] < 120. && m_ll_subleading[0] > 12. && m_ll_subleading[0] < 120.)", # increasing pT cuts on the pTmumu 
            "sel3_pTH350_400":"(pT_llll[0] > 350. && pT_llll[0] < 400.) && (ZZ_llll_flavour[0] == 1) && (m_ll_leading[0] > 40. && m_ll_leading[0] < 120. && m_ll_subleading[0] > 12. && m_ll_subleading[0] < 120.)", # increasing pT cuts on the pTmumu 
            "sel3_pTH400_450":"(pT_llll[0] > 400. && pT_llll[0] < 450.) && (ZZ_llll_flavour[0] == 1) && (m_ll_leading[0] > 40. && m_ll_leading[0] < 120. && m_ll_subleading[0] > 12. && m_ll_subleading[0] < 120.)", # increasing pT cuts on the pTmumu 
            "sel3_pTH450_500":"(pT_llll[0] > 450. && pT_llll[0] < 500.) && (ZZ_llll_flavour[0] == 1) && (m_ll_leading[0] > 40. && m_ll_leading[0] < 120. && m_ll_subleading[0] > 12. && m_ll_subleading[0] < 120.)", # increasing pT cuts on the pTmumu 
            "sel3_pTH500_550":"(pT_llll[0] > 500.) && (ZZ_llll_flavour[0] == 1) && (m_ll_leading[0] > 40. && m_ll_leading[0] < 120. && m_ll_subleading[0] > 12. && m_ll_subleading[0] < 120.)", # increasing pT cuts on the pTmumu 
            }
...
histoList = {
    ...
    "leading_pair_lep1_pt":{"name":"leading_pair_lep1_pt","title":"pT_{#mu} (leading) [GeV]","bin":50,"xmin":0.,"xmax":200.},
}