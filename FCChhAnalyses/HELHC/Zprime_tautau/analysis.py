...
comp = cfg.Component(
    'example',
    files = ["/eos/experiment/fcc/helhc/generation/DelphesEvents/helhc_v01/p8_pp_ZprimeSSM_6TeV_ll/events_033287615.root"]
...
# select pf04 jets above 400 GeV for b-tagging
...
from FCChhAnalyses.HELHC.Zprime_tautau.TreeProducer import TreeProducer
