...
inputDir  = "/afs/cern.ch/user/d/dimoulin/FCCAnalyses/repeatTanishq/Analysis/HNL_Dirac_20GeV_1e-3Ve_analysis/output_stage1_HNL_Dirac_20GeV_1e-3Ve"
...
outputDir  = "HNL_Dirac_20GeV_1e-3Ve_analysis/output_finalSel_HNL_Dirac_20GeV_1e-3Ve/"

processList = {
    #run over the full statistics from stage1
    'HNL_Dirac_20GeV_1e-3Ve':{},
}
