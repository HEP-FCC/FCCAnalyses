...
energy         = 91
collider       = 'FCC-ee'
inputDir       = '/afs/cern.ch/user/d/dimoulin/FCCAnalyses/repeatTanishq/Analysis/final_analysis/70GeV/'
#formats        = ['png','pdf']
formats        = ['pdf']
yaxis          = ['lin','log']
stacksig       = ['nostack']
outdir         = 'analysis_plots/70GeV/'
splitLeg       = True
...
colors['HNL_Majorana_70GeV_1e-3Ve'] = ROOT.kBlue
colors['HNL_Dirac_70GeV_1e-3Ve'] = ROOT.kRed

plots = {}
plots['HNL'] = {'signal':{
                     'HNL_Majorana_70GeV_1e-3Ve':['HNL_Majorana_70GeV_1e-3Ve'],
                     'HNL_Dirac_70GeV_1e-3Ve':['HNL_Dirac_70GeV_1e-3Ve'],
...
legend['HNL_Majorana_70GeV_1e-3Ve'] = 'HNL_Majorana_70GeV_1e-3Ve'
legend['HNL_Dirac_70GeV_1e-3Ve'] = 'HNL_Dirac_70GeV_1e-3Ve'
