...
f = np.load('multiclass_HT_noL_1705_HT_noL_1705.npz')
...
plt.title(r'$\mathbf{CMS}$ Simulation - (ABCNet on $\mathbf{QCD}$ Jets), $\sqrt{s}$ = 13 TeV')
#plt.title(r'$\mathbf{CMS}$ Simulation - (ABCNet on $\mathbf{cutDY}$ Jets), $\sqrt{s}$ = 13 TeV')
...
plt.savefig('thesis_opti/Standard.png')
                                                                                                                                     138,1         Bot
