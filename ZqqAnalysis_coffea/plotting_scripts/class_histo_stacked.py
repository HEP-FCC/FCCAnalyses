...
plt.hist([CNN_s, CNN_o], histtype='step', label=['strange jets','down+up jets'], density=False, bins=bins, stacked=True)
#plt.hist([CNN_s, CNN_o], facecolor='b', edgecolor='b', histtype='step', label='strange jets', density=False, bins=bins, stacked=True)
#plt.hist(CNN_o, facecolor='r', edgecolor='r', histtype='step', label='down+up jets', density=False, bins=bins, stacked=True)
#plt.yscale('log')
...
plt.savefig('../plots/class_histo_stacked.pdf')
