...
C     
C     Process: e+ e- > n1 ve~ WEIGHTED<=4 @3
...
C     ----------
     ...
     $   ), ZERO)
      ...
      CALL FFS7_1(W(1,5),W(1,6),GC_87,MDL_MN1, FK_MDL_WN1,W(1,7))
      CALL IXXXXX(P(0,6),ZERO,NHEL(6),-1*IC(6),W(1,6))
      CALL FFS8_3(W(1,2),W(1,1),GC_172,MDL_MH, FK_MDL_WH,W(1,8))
C     Amplitude(s) for diagram number 1
      CALL FFS5_0(W(1,6),W(1,7),W(1,8),GC_87,AMP(1))
      CALL FFV7_9_3(W(1,3),W(1,4),GC_68,GC_77,MDL_MZ, FK_MDL_WZ,W(1,9))
      CALL FFV7_1(W(1,5),W(1,9),GC_85,MDL_MN1, FK_MDL_WN1,W(1,10))
C     Amplitude(s) for diagram number 2
      CALL FFS5_0(W(1,6),W(1,10),W(1,8),GC_87,AMP(2))
      CALL FFV7_3(W(1,3),W(1,5),GC_58,MDL_MW, FK_MDL_WW,W(1,9))
      CALL FFV7_1(W(1,4),W(1,9),GC_84,MDL_MN1, FK_MDL_WN1,W(1,5))
C     Amplitude(s) for diagram number 3
      CALL FFS5_0(W(1,6),W(1,5),W(1,8),GC_87,AMP(3))
      CALL FFV7_9_3(W(1,2),W(1,1),GC_68,GC_77,MDL_MZ, FK_MDL_WZ,W(1,8))
C     Amplitude(s) for diagram number 4
      CALL FFV7_0(W(1,6),W(1,7),W(1,8),GC_85,AMP(4))
C     Amplitude(s) for diagram number 5
      CALL FFV7_0(W(1,6),W(1,10),W(1,8),GC_85,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL FFV7_0(W(1,6),W(1,5),W(1,8),GC_85,AMP(6))
      CALL FFV7_3(W(1,6),W(1,1),GC_58,MDL_MW, FK_MDL_WW,W(1,8))
C     Amplitude(s) for diagram number 7
      CALL FFV7_0(W(1,2),W(1,7),W(1,8),GC_84,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFV7_0(W(1,2),W(1,10),W(1,8),GC_84,AMP(8))
C     Amplitude(s) for diagram number 9
      CALL FFV7_0(W(1,2),W(1,5),W(1,8),GC_84,AMP(9))
