...
C     
C     Process: u u~ > t t~ WEIGHTED<=2 @1
C     Process: c c~ > t t~ WEIGHTED<=2 @1
C     Process: d d~ > t t~ WEIGHTED<=2 @1
C     Process: s s~ > t t~ WEIGHTED<=2 @1
C     
...
C     Continue only if IMODE is 0, 4 or 5
      ...
      IF (ABS(LPP(IB(1))).GE.1) THEN
        LP=SIGN(1,LPP(IB(1)))
        D1=PDG2PDF(ABS(LPP(IB(1))),1*LP, 1,XBK(IB(1)),DSQRT(Q2FACT(1)))
