...
C     
C     Process: e+ e- > z WEIGHTED<=2 @6
C     *   Decay: z > n1 ve~ WEIGHTED<=2
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     ----------
     ...
     $   , ZERO)
      ...
      CALL OXXXXX(P(0,3),MDL_MN1,NHEL(3),+1*IC(3),W(1,3))
      CALL IXXXXX(P(0,4),ZERO,NHEL(4),-1*IC(4),W(1,4))
      CALL FFV5_3(W(1,4),W(1,3),GC_50,MDL_MZ, FK_MDL_WZ,W(1,5))
C     Amplitude(s) for diagram number 1
      CALL FFV5_6_0(W(1,2),W(1,1),W(1,5),GC_44,GC_40,AMP(1))
