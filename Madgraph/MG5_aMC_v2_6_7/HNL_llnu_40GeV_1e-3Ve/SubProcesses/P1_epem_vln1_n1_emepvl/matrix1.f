...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WW)
        FK_MDL_WN1 = SIGN(MAX(ABS(MDL_WN1), ABS(MDL_MN1
     $   *SMALL_WIDTH_TREATMENT)), MDL_WN1)
     ...
     $   , ZERO)
        FK_ZERO = SIGN(MAX(ABS(ZERO), ABS(MDL_ME*SMALL_WIDTH_TREATMENT)
     $   ), ZERO)
      ENDIF


      CALL OXXXXX(P(0,1),MDL_ME,NHEL(1),-1*IC(1),W(1,1))
      CALL IXXXXX(P(0,2),MDL_ME,NHEL(2),+1*IC(2),W(1,2))
      ...
      CALL FFS1_3(W(1,5),W(1,4),GC_149,MDL_MH, FK_MDL_WH,W(1,7))
      CALL FFS4C1_2(W(1,6),W(1,7),GC_52,MDL_MN1, FK_MDL_WN1,W(1,8))
      CALL FFS1_3(W(1,2),W(1,1),GC_149,MDL_MH, FK_MDL_WH,W(1,7))
C     Amplitude(s) for diagram number 1
      CALL FFS4_0(W(1,8),W(1,3),W(1,7),GC_52,AMP(1))
      CALL FFV5_6_3(W(1,5),W(1,4),GC_44,GC_40,MDL_MZ, FK_MDL_WZ,W(1,9))
      CALL FFV5C1_2(W(1,6),W(1,9),GC_50,MDL_MN1, FK_MDL_WN1,W(1,4))
C     Amplitude(s) for diagram number 2
      CALL FFS4_0(W(1,4),W(1,3),W(1,7),GC_52,AMP(2))
      CALL OXXXXX(P(0,6),ZERO,NHEL(6),+1*IC(6),W(1,9))
      CALL FFV5_3(W(1,5),W(1,9),GC_22,MDL_MW, FK_MDL_WW,W(1,6))
      CALL IXXXXX(P(0,4),MDL_ME,NHEL(4),-1*IC(4),W(1,9))
      CALL FFV5C1_2(W(1,9),W(1,6),GC_49,MDL_MN1, FK_MDL_WN1,W(1,5))
C     Amplitude(s) for diagram number 3
      CALL FFS4_0(W(1,5),W(1,3),W(1,7),GC_52,AMP(3))
      CALL FFV5_6_3(W(1,2),W(1,1),GC_44,GC_40,MDL_MZ, FK_MDL_WZ,W(1,7))
C     Amplitude(s) for diagram number 4
      CALL FFV5_0(W(1,8),W(1,3),W(1,7),GC_50,AMP(4))
C     Amplitude(s) for diagram number 5
      CALL FFV5_0(W(1,4),W(1,3),W(1,7),GC_50,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL FFV5_0(W(1,5),W(1,3),W(1,7),GC_50,AMP(6))
      CALL FFV5_3(W(1,8),W(1,1),GC_49,MDL_MW, FK_MDL_WW,W(1,7))
C     Amplitude(s) for diagram number 7
      CALL FFV5_0(W(1,2),W(1,3),W(1,7),GC_22,AMP(7))
      CALL FFV5_3(W(1,4),W(1,1),GC_49,MDL_MW, FK_MDL_WW,W(1,7))
C     Amplitude(s) for diagram number 8
      CALL FFV5_0(W(1,2),W(1,3),W(1,7),GC_22,AMP(8))
      CALL FFV5_3(W(1,5),W(1,1),GC_49,MDL_MW, FK_MDL_WW,W(1,7))
C     Amplitude(s) for diagram number 9
      CALL FFV5_0(W(1,2),W(1,3),W(1,7),GC_22,AMP(9))
