...
C     
      ...
      P3(2) = -DIMAG(V3(2))
      P3(3) = -DIMAG(V3(1))
      TMP4 = (F1(3)*(F2(5)*(P3(0)+P3(3))+F2(6)*(P3(1)+CI*(P3(2))))
     $ +F1(4)*(F2(5)*(P3(1)-CI*(P3(2)))+F2(6)*(P3(0)-P3(3))))
      DENOM = COUP/(P3(0)**2-P3(1)**2-P3(2)**2-P3(3)**2 - M3 * (M3 -CI
     $ * W3))
      V3(3)= DENOM*(-CI)*(F2(5)*F1(3)+F2(6)*F1(4)-P3(0)*OM3*TMP4)
      V3(4)= DENOM*(-CI)*(-F2(6)*F1(3)-F2(5)*F1(4)-P3(1)*OM3*TMP4)
      V3(5)= DENOM*(-CI)*(-CI*(F2(6)*F1(3))+CI*(F2(5)*F1(4))-P3(2)*OM3
     $ *TMP4)
      V3(6)= DENOM*(-CI)*(F2(6)*F1(4)-F2(5)*F1(3)-P3(3)*OM3*TMP4)
      END
...
C     
      ...
      COMPLEX*16 VTMP(6)
      INTEGER*4 I
      CALL FFV5_3(F1,F2,COUP1,M3,W3,V3)
