...
V_152 = Vertex(name = 'V_152',
               ...
               couplings = {(0,1):C.GC_69,(0,0):C.GC_76})
...
V_191 = Vertex(name = 'V_191',
               particles = [ P.N1__tilde__, P.e__minus__, P.G__plus__ ],
               color = [ '1' ],
               lorentz = [ L.FFS7 ],
               couplings = {(0,0):C.GC_89})

V_192 = Vertex(name = 'V_192',
               particles = [ P.N2__tilde__, P.e__minus__, P.G__plus__ ],
               color = [ '1' ],
               lorentz = [ L.FFS7 ],
               couplings = {(0,0):C.GC_96})

V_193 = Vertex(name = 'V_193',
               particles = [ P.N3__tilde__, P.e__minus__, P.G__plus__ ],
               color = [ '1' ],
               lorentz = [ L.FFS7 ],
               couplings = {(0,0):C.GC_103})

V_194 = Vertex(name = 'V_194',
               particles = [ P.N1__tilde__, P.mu__minus__, P.G__plus__ ],
               color = [ '1' ],
               lorentz = [ L.FFS7 ],
               couplings = {(0,0):C.GC_126})

V_195 = Vertex(name = 'V_195',
               particles = [ P.N2__tilde__, P.mu__minus__, P.G__plus__ ],
               color = [ '1' ],
               lorentz = [ L.FFS7 ],
               couplings = {(0,0):C.GC_133})

V_196 = Vertex(name = 'V_196',
               particles = [ P.N3__tilde__, P.mu__minus__, P.G__plus__ ],
               color = [ '1' ],
               lorentz = [ L.FFS7 ],
               couplings = {(0,0):C.GC_140})

V_197 = Vertex(name = 'V_197',
               particles = [ P.N1__tilde__, P.ta__minus__, P.G__plus__ ],
               color = [ '1' ],
               lorentz = [ L.FFS7 ],
               couplings = {(0,0):C.GC_147})

V_198 = Vertex(name = 'V_198',
               particles = [ P.N2__tilde__, P.ta__minus__, P.G__plus__ ],
               color = [ '1' ],
               lorentz = [ L.FFS7 ],
               couplings = {(0,0):C.GC_154})

V_199 = Vertex(name = 'V_199',
               particles = [ P.N3__tilde__, P.ta__minus__, P.G__plus__ ],
               color = [ '1' ],
               lorentz = [ L.FFS7 ],
               couplings = {(0,0):C.GC_161})

V_200 = Vertex(name = 'V_200',
               particles = [ P.N1__tilde__, P.ve, P.G0 ],
               color = [ '1' ],
               lorentz = [ L.FFS7 ],
               couplings = {(0,0):C.GC_86})

V_201 = Vertex(name = 'V_201',
               particles = [ P.N1__tilde__, P.ve, P.H ],
               color = [ '1' ],
               lorentz = [ L.FFS7 ],
               couplings = {(0,0):C.GC_87})

V_202 = Vertex(name = 'V_202',
               particles = [ P.N2__tilde__, P.ve, P.G0 ],
               color = [ '1' ],
               lorentz = [ L.FFS7 ],
               couplings = {(0,0):C.GC_93})

V_203 = Vertex(name = 'V_203',
               particles = [ P.N2__tilde__, P.ve, P.H ],
               color = [ '1' ],
               lorentz = [ L.FFS7 ],
               couplings = {(0,0):C.GC_94})

V_204 = Vertex(name = 'V_204',
               particles = [ P.N3__tilde__, P.ve, P.G0 ],
               color = [ '1' ],
               lorentz = [ L.FFS7 ],
               couplings = {(0,0):C.GC_100})

V_205 = Vertex(name = 'V_205',
               particles = [ P.N3__tilde__, P.ve, P.H ],
               color = [ '1' ],
               lorentz = [ L.FFS7 ],
               couplings = {(0,0):C.GC_101})

V_206 = Vertex(name = 'V_206',
               particles = [ P.N1__tilde__, P.vm, P.G0 ],
               color = [ '1' ],
               lorentz = [ L.FFS7 ],
               couplings = {(0,0):C.GC_123})

V_207 = Vertex(name = 'V_207',
               particles = [ P.N1__tilde__, P.vm, P.H ],
               color = [ '1' ],
               lorentz = [ L.FFS7 ],
               couplings = {(0,0):C.GC_124})

V_208 = Vertex(name = 'V_208',
               particles = [ P.N2__tilde__, P.vm, P.G0 ],
               color = [ '1' ],
               lorentz = [ L.FFS7 ],
               couplings = {(0,0):C.GC_130})

V_209 = Vertex(name = 'V_209',
               particles = [ P.N2__tilde__, P.vm, P.H ],
               color = [ '1' ],
               lorentz = [ L.FFS7 ],
               couplings = {(0,0):C.GC_131})

V_210 = Vertex(name = 'V_210',
               particles = [ P.N3__tilde__, P.vm, P.G0 ],
               color = [ '1' ],
               lorentz = [ L.FFS7 ],
               couplings = {(0,0):C.GC_137})

V_211 = Vertex(name = 'V_211',
               particles = [ P.N3__tilde__, P.vm, P.H ],
               color = [ '1' ],
               lorentz = [ L.FFS7 ],
               couplings = {(0,0):C.GC_138})

V_212 = Vertex(name = 'V_212',
               particles = [ P.N1__tilde__, P.vt, P.G0 ],
               color = [ '1' ],
               lorentz = [ L.FFS7 ],
               couplings = {(0,0):C.GC_144})

V_213 = Vertex(name = 'V_213',
               particles = [ P.N1__tilde__, P.vt, P.H ],
               color = [ '1' ],
               lorentz = [ L.FFS7 ],
               couplings = {(0,0):C.GC_145})

V_214 = Vertex(name = 'V_214',
               particles = [ P.N2__tilde__, P.vt, P.G0 ],
               color = [ '1' ],
               lorentz = [ L.FFS7 ],
               couplings = {(0,0):C.GC_151})

V_215 = Vertex(name = 'V_215',
               particles = [ P.N2__tilde__, P.vt, P.H ],
               color = [ '1' ],
               lorentz = [ L.FFS7 ],
               couplings = {(0,0):C.GC_152})

V_216 = Vertex(name = 'V_216',
               particles = [ P.N3__tilde__, P.vt, P.G0 ],
               color = [ '1' ],
               lorentz = [ L.FFS7 ],
               couplings = {(0,0):C.GC_158})

V_217 = Vertex(name = 'V_217',
               particles = [ P.N3__tilde__, P.vt, P.H ],
               color = [ '1' ],
               lorentz = [ L.FFS7 ],
               couplings = {(0,0):C.GC_159})
...
V_227 = Vertex(name = 'V_227',
               particles = [ P.N1__tilde__, P.e__minus__, P.W__plus__ ],
               color = [ '1' ],
               lorentz = [ L.FFV7 ],
               couplings = {(0,0):C.GC_84})

V_228 = Vertex(name = 'V_228',
               particles = [ P.N2__tilde__, P.e__minus__, P.W__plus__ ],
               color = [ '1' ],
               lorentz = [ L.FFV7 ],
               couplings = {(0,0):C.GC_91})

V_229 = Vertex(name = 'V_229',
               particles = [ P.N3__tilde__, P.e__minus__, P.W__plus__ ],
               color = [ '1' ],
               lorentz = [ L.FFV7 ],
               couplings = {(0,0):C.GC_98})

V_230 = Vertex(name = 'V_230',
               particles = [ P.N1__tilde__, P.mu__minus__, P.W__plus__ ],
               color = [ '1' ],
               lorentz = [ L.FFV7 ],
               couplings = {(0,0):C.GC_121})

V_231 = Vertex(name = 'V_231',
               particles = [ P.N2__tilde__, P.mu__minus__, P.W__plus__ ],
               color = [ '1' ],
               lorentz = [ L.FFV7 ],
               couplings = {(0,0):C.GC_128})

V_232 = Vertex(name = 'V_232',
               particles = [ P.N3__tilde__, P.mu__minus__, P.W__plus__ ],
               color = [ '1' ],
               lorentz = [ L.FFV7 ],
               couplings = {(0,0):C.GC_135})

V_233 = Vertex(name = 'V_233',
               particles = [ P.N1__tilde__, P.ta__minus__, P.W__plus__ ],
               color = [ '1' ],
               lorentz = [ L.FFV7 ],
               couplings = {(0,0):C.GC_142})

V_234 = Vertex(name = 'V_234',
               particles = [ P.N2__tilde__, P.ta__minus__, P.W__plus__ ],
               color = [ '1' ],
               lorentz = [ L.FFV7 ],
               couplings = {(0,0):C.GC_149})

V_235 = Vertex(name = 'V_235',
               particles = [ P.N3__tilde__, P.ta__minus__, P.W__plus__ ],
               color = [ '1' ],
               lorentz = [ L.FFV7 ],
               couplings = {(0,0):C.GC_156})
...
V_245 = Vertex(name = 'V_245',
               particles = [ P.N1__tilde__, P.ve, P.Z ],
               color = [ '1' ],
               lorentz = [ L.FFV7 ],
               couplings = {(0,0):C.GC_85})

V_246 = Vertex(name = 'V_246',
               particles = [ P.N2__tilde__, P.ve, P.Z ],
               color = [ '1' ],
               lorentz = [ L.FFV7 ],
               couplings = {(0,0):C.GC_92})

V_247 = Vertex(name = 'V_247',
               particles = [ P.N3__tilde__, P.ve, P.Z ],
               color = [ '1' ],
               lorentz = [ L.FFV7 ],
               couplings = {(0,0):C.GC_99})

V_248 = Vertex(name = 'V_248',
               particles = [ P.N1__tilde__, P.vm, P.Z ],
               color = [ '1' ],
               lorentz = [ L.FFV7 ],
               couplings = {(0,0):C.GC_122})

V_249 = Vertex(name = 'V_249',
               particles = [ P.N2__tilde__, P.vm, P.Z ],
               color = [ '1' ],
               lorentz = [ L.FFV7 ],
               couplings = {(0,0):C.GC_129})

V_250 = Vertex(name = 'V_250',
               particles = [ P.N3__tilde__, P.vm, P.Z ],
               color = [ '1' ],
               lorentz = [ L.FFV7 ],
               couplings = {(0,0):C.GC_136})

V_251 = Vertex(name = 'V_251',
               particles = [ P.N1__tilde__, P.vt, P.Z ],
               color = [ '1' ],
               lorentz = [ L.FFV7 ],
               couplings = {(0,0):C.GC_143})

V_252 = Vertex(name = 'V_252',
               particles = [ P.N2__tilde__, P.vt, P.Z ],
               color = [ '1' ],
               lorentz = [ L.FFV7 ],
               couplings = {(0,0):C.GC_150})

V_253 = Vertex(name = 'V_253',
               particles = [ P.N3__tilde__, P.vt, P.Z ],
               color = [ '1' ],
               lorentz = [ L.FFV7 ],
               couplings = {(0,0):C.GC_157})
